...
public class MainFormController implements Initializable {
    ...
    public void dashboardNSP() {
        ...
        String sql = "SELECT COUNT(quantity) FROM history_customer";
    ...
    private String[] typeList = {"Fluid", "Tool"};
    ...
    public ObservableList<ProductData> menuGetOrder() {
        ...
        String sql = "SELECT * FROM history_customer WHERE customer_id = " + cID;
    ...
    public void menuGetTotal() {
        customerID();
        String total = "SELECT SUM(price) FROM history_customer WHERE customer_id = " + cID;
