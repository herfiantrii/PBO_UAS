...
public class CustomerPageController implements Initializable {
    ...
    public void loginBtn() {
        ...
        if (si_username.getText().isEmpty() || si_password.getText().isEmpty()) {
            ...
            String selctData = "SELECT id, username, password FROM customer WHERE username = ? and password = ?";
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    int loggedInCustomerID = result.getInt("id");
                    Data.cID = loggedInCustomerID;
                    ...
                    stage.setTitle("Sanitation Mart Application (Customer)");
    ...
    public void regBtn() {
        ...
        if (su_username.getText().isEmpty() || su_password.getText().isEmpty()
            ...
            String regData = "INSERT INTO customer (username, password, question, answer, date) "
                    + "VALUES(?,?,?,?,?)";
            connect = Database.connectDB();
            
            try {
                // CHECK IF THE USERNAME IS ALREADY RECORDED
                String checkUsername = "SELECT username FROM customer WHERE username = '"
                        + su_username.getText() + "'";
    ...
    public void proceedBtn() {
        ...
        if (fp_username.getText().isEmpty() || fp_question.getSelectionModel().getSelectedItem() == null
            ...
            String selectData = "SELECT username, question, answer FROM customer WHERE username = ? AND question = ? AND answer = ?";
            connect = Database.connectDB();
    ...
    public void changePassBtn() {
        ...
        if (np_newPassword.getText().isEmpty() || np_confirmPassword.getText().isEmpty()) {
            ...
            if (np_newPassword.getText().equals(np_confirmPassword.getText())) {
                String getDate = "SELECT date FROM customer WHERE username = '"
                        + fp_username.getText() + "'";
                ...
                try {
                    ...
                    String updatePass = "UPDATE customer SET password = '"
    ...
    public void userList() {
        ...
        listU.add("Staff Portal");
        listU.add("Customer Portal");
        // Add any other user types if needed
    ...
    public void switchPage() {
        ...
        if ("Staff Portal".equals(login_user.getSelectionModel().getSelectedItem())) {
        ...
        } else if ("Customer Portal".equals(login_user.getSelectionModel().getSelectedItem())) {
